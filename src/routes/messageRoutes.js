...
router.get('/conversation/:conversationId/messages', authenticateToken, MessageController.getMessages);

// Marquer les messages comme lus
router.patch('/conversation/:conversationId/read', authenticateToken, MessageController.markMessagesAsRead);
